...
function retrieveTransactions() {
    return new Promise((resolve, reject) => {
        var fakedata = {
            "body": [{
                    "transaction_id": "8d498a2e-071c-4ffd-b9f7-08d5as88ec28",
                    "fk_user_id": 1,
                    "fk_merchant_id": 1,
                    "fk_branch_id": 1,
                ...
                {
                    "transaction_id": "a8d8634c-df6f-454e-c4b3-08d5042d5f26",
                    "fk_user_id": 1,
                    "fk_merchant_id": 1,
                    "fk_branch_id": 1,
                    "braintree_transaction_id": "ABC-12345",
                ...
                {
                    "transaction_id": "90e8c-0c7c-4a8f-c4b4-08d51218d5f26",
                    "fk_user_id": 2,
                    "fk_merchant_id": 2,
                    "fk_branch_id": 2,
                    "braintree_transaction_id": "ABC-12345",
                ...
                {
                    "transaction_id": "90da4e318c-0c1317c-4a2f-c4b4-08d5018d5f26",
                    "fk_user_id": 3,
                    "fk_merchant_id": 5,
                    "fk_branch_id": 2,
                    "braintree_transaction_id": "ABC-12345",
                ...
                {
                    "transaction_id": "90da4e5648c-0c7c-4a2f-c4b4-08d5018d5f26",
                    "fk_user_id": 3,
                    "fk_merchant_id": 1,
                    "fk_branch_id": 2,
                    "braintree_transaction_id": "ABC-12345",
                ...
                {
                    "transaction_id": "90da21310c7c-4a2f-c4b4-08d5018d5f26",
                    "fk_user_id": 3,
                    "fk_merchant_id": 5,
                    "fk_branch_id": 2,
                    "braintree_transaction_id": "ABC-12345",
                ...
                {
                    "transaction_id": "9c24-0c7c-4a2f-c4b4-08d5018d5f26",
                    "fk_user_id": 3,
                    "fk_merchant_id": 5,
                    "fk_branch_id": 2,
                    "braintree_transaction_id": "ABC-12345",
...
// retrieveIdTransaction('8d498a2e-071c-4ffd-b9f7-08d50188ec28')
...
// confirmTransaction('8d498a2e-071c-4ffd-b9f7-08d50188ec28')
...
function confirmTransaction(transactionId) {
    return new Promise((resolve, reject) => {
        ...
        promiseRetrieveTransaction.then((value) => {
            for (var i = 0; i < value.body.length; i++) {
                if (value.body[i].transaction_id == transactionId) {
                    value.body[i].is_transaction_complete = true
...
module.exports.buildSTdata = buildSTdata
...
function letsMerge(merchant_idd){
    return new Promise((resolve, reject) => {
        ...
        openletsMergept1.then((body)=>{
            openretrieveMerchants = retrieveMerchants()
            openretrieveMerchants.then((merchantdata)=>{

                var newBody = body
                // console.log(merchantdata)
                for ( var counter =0 ; counter < merchantdata.length ; counter ++){
                    if (merchantdata[counter].merchant_id ==merchant_idd ){
                        newBody.merchant_name=merchantdata[counter].company_name
                        // console.log(merchantdata[counter].company_name)
                    }
                }
                // console.log(newBody)
                resolve(newBody)
...
// /*TEST:*/ InsertSettlement("8d498a2e-071c-4ffd-b9f7-08d50188ec28")

function InsertSettlement(transactionId) {
    return new Promise((resolve, reject) => {

        var promiseRetrieveSettlements = retrieveSettlements(); // check if transaction has been settled
        promiseRetrieveSettlements.then((value) => {
                ...
                if (arg == true) {
                    ...
                    var promiseRetrieveIdTransaction = retrieveIdTransaction(transactionId); // search for transaction detail from our transaction database

                    promiseRetrieveIdTransaction.then((value) => {


                                var money = parseFloat(commission(value.transaction_amount)).toFixed(2);
                               
                                console.log ("value.body.fk_merchant_id :"+value.fk_merchant_id  )
                                console.log ("value.body.fk_branch_id :"+value.fk_branch_id )
                                console.log ("transactionId :"+transactionId )
                                console.log(money)
                                var promiseCreateSettlement = createSettlement(value.fk_merchant_id, value.fk_branch_id, transactionId, money); // create settlement record
                                promiseCreateSettlement.then((value2) => {
                                        console.log("createSettlement :" + JSON.stringify(value2))

                                        // var promiseConfirmTransaction = confirmTransaction(transactionId);
